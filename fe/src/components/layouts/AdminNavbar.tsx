      ...
      >
        <div className={cn('shrink-0 sm:min-w-0')}>
          <Link
            to="/admin"
            className={cn(
              'text-sm font-bold tracking-wide text-white text-decoration-none block truncate',
        ...
        <div
          className={cn(
            'flex flex-row items-center justify-end sm:justify-between flex-1 sm:min-w-0'
          )}
        >
